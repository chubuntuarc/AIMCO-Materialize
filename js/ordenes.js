...
//Funciones de la muestra de graficos por año------------------------------------------------------------------------------------------------------------------
  ...
  $('#year_anterior').on('click', function() {
      ...
      $('#total_ordenes_clientes').text("Total: ".concat(ordenes2015));
    ...
    $('#year').on('click', function() {
        ...
        $('#total_ordenes_clientes').text("Total: ".concat(ordenes2016));
        //Cambio de valores en base al año en boton rojo
      ...
      $('#year_anterior_2').on('click', function() {
          ...
          $('#total_ordenes_clientes').text("Total: ".concat(ordenes2014));
          //Cambio de valores en base al año en boton rojo
        ...
        $('#year_anterior_3').on('click', function() {
            $('#boton').text("2013");
            var ordenes2013 = document.getElementById("ordenes2013").value;   //Cadena capturada de los input ocultos en el DO
            $('#total_ordenes_clientes').text("Total: ".concat(ordenes2013));
            //Cambio de valores en base al año en boton rojo
