...
<html>
<head>
  <link rel="stylesheet" href="../css/ofertas.css" media="screen" title="no title" charset="utf-8"><!--Stylesheet Exclusivo de Ofertas.php-->
</head>
  <body>
    ...
    <?php include("../assets/dashboard/ofertas/grafica.php"); ?>                <!--Gráfica de facturas-->
    <?php include("../assets/dashboard/ofertas/busqueda.php"); ?>               <!--Busqueda de Facturas-->
    <?php include("../assets/dashboard/ofertas/vista_previa.php"); ?>           <!--Modal de Vista Previa de facturas-->
  ...
  <script type="text/javascript" src="../js/ofertas.js"></script>               <!--Script exclusivo de la información de ofertas-->
</html>
