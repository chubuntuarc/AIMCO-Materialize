...
<head>
  ...
  <body>
    ...
    <?php include("../assets/dashboard/ordenes/grafica.php"); ?>                <!--Gráfica de facturas-->
    <?php include("../assets/dashboard/ordenes/busqueda.php"); ?>               <!--Busqueda de Facturas-->
    <?php include("../assets/dashboard/ordenes/vista_previa.php"); ?>           <!--Modal de Vista Previa de facturas-->
  ...
  <script type="text/javascript" src="../js/ordenes.js"></script>               <!--Script exclusivo de la información de facturación-->
</html>
